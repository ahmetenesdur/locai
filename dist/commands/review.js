...
class ReviewCommand {
    ...
    loadReviewQueue() {
        ...
        if (!fs.existsSync(reviewFile)) {
            ...
            console.log("   Run translation with confidence scoring first: localize translate --min-confidence 0.8");
            return false;
        }
        try {
    ...
    showSummary() {
        ...
        console.log(`Total:     ${this.decisions.accepted.length + this.decisions.edited.length + this.decisions.rejected.length + this.decisions.skipped.length}/${this.reviewQueue.length}`);
        console.log("━".repeat(70));
    }
    /**
