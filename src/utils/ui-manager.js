...
export class UIManager {
	 ...
	 * @param {number} totalLanguages - Count of languages
	 */
	async displayGlobalSummary(stats, totalLanguages) {
		...
		await this.log(`Total Time: ${stats.totalTime.toFixed(1)}s`);
		await this.log(`Average per language: ${(stats.totalTime / totalLanguages).toFixed(1)}s`);
